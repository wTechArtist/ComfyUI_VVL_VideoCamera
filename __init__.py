...
try:
    from .colmap_pointcloud import NODE_CLASS_MAPPINGS as PC_NODE_MAPPINGS, NODE_DISPLAY_NAME_MAPPINGS as PC_DISPLAY_MAPPINGS
except ImportError as e:
    print(f"Warning: Could not import PointCloud node: {e}")
    PC_NODE_MAPPINGS = {}
    PC_DISPLAY_MAPPINGS = {}
